...
var clustersResource = schema.GroupVersionResource{Group: "yugabytedb.rook.io", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "yugabytedb.rook.io", Version: "v1alpha1", Kind: "Cluster"}
